...
public class SkoreaSquare extends Panel_1{
    public ImageIcon image = new ImageIcon("Images/skoreaEmblem.png");
    private String heading = "South Korea";
    private String infoFilePath = "Information_center/skorea.txt";
    ...
    protected JButton mutateBtn(){
        ...
        btn.addActionListener(new Action() {
            ...
            public void actionPerformed(ActionEvent e) {
                SkoreaPopup skoreaPopUp = new SkoreaPopup();
            }
        });
        return btn;
    }
