...
public class TurkeyPopup extends PopUp{
    protected  String heading = "Turkey";
    protected ImageIcon image = new ImageIcon("PicturesInPopup/turkey.png");
    protected String textPath = "Information_center/turkeypopup.txt";
