...
import com.military.frontend.weaponryPop.GustavP;
...
public class SchwererGustav extends Panel_1 {
    public ImageIcon image = new ImageIcon("Images/gustav.jpg");
    private String heading = "Schwerer Gustav";
    private String infoFilePath = "Information_center/gustav.txt";
