...
import com.military.frontend.weaponryPop.UavP;
...
public class UAV extends Panel_1 {
    public ImageIcon image = new ImageIcon("Images/uav.jpg");
    private String heading = "UAV";
    private String infoFilePath = "Information_center/uav.txt";
