...
import com.military.frontend.weaponryPop.MirvP;
...
public class mirv extends Panel_1 {
    public ImageIcon image = new ImageIcon("Images/mirv.jpg");
    private String heading = "MIRV";
    private String infoFilePath = "Information_center/mirv.txt";
