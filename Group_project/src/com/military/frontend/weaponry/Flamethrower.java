...
public class Flamethrower extends Panel_1 {
    public ImageIcon image = new ImageIcon("Images/Flamethrower.png");
    private String heading = "Flamethrower";
    private String infoFilePath = "Information_center/flame.txt";
