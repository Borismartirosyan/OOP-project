...
public class FranceSquare extends Panel_1{
    public ImageIcon image = new ImageIcon("Images/franceEmblem.png");
    private String heading = "France";
    private String infoFilePath = "Information_center/france.txt";
    ...
    protected JButton mutateBtn(){
        ...
        btn.addActionListener(new Action() {
            ...
            public void actionPerformed(ActionEvent e) {
                FrancePopup francePopUp = new FrancePopup();
            }
        });
        return btn;
    }
