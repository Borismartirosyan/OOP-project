...
public class IndiaSquare extends Panel_1{
    public ImageIcon image = new ImageIcon("Images/indiaEmblem.png");
    private String heading = "India";
    private String infoFilePath = "Information_center/india.txt";
    ...
    protected JButton mutateBtn(){
        ...
        btn.addActionListener(new Action() {
            ...
            public void actionPerformed(ActionEvent e) {
                IndiaPopup indiaPopUp = new IndiaPopup();
            }
        });
        return btn;
    }
